...
# C57BL/6J Kupffer cell analysis using nichenet
# Notebook to run NicheNet regression on C57BL/6J specific genes (union set)
...
geneset = "./nichenet_c57Union.tsv" # pick set of target genes
tpm = 10 # TPM to define an 'expressed' gene
out_prefix = 'c57bl6_kupffer'
out_directory = './C57BL6J/'
...
foreground_set = expressed_genes_c57_kup
niche_set = expressed_genes_c57_niche
...
hep_spec_ligands = c('PLG', 'VEGFA', 'CALR')
lsec_spec_ligands = c()
stel_spec_ligands = c('CXCL12', 'SPP1')
hep_lsec_ligands = c()
hep_stel_ligands = c()
lsec_stel_ligands = c('APP', 'ADAM17', 'ICAM1')
general_ligands = c('NAMPT', 'RPS19')
